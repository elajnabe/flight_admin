...
-- Portals display
RegisterNUICallback('flight_admin:setPortalCheckbox', function(data, cb)
    local tmp = {}
...
RegisterNUICallback('flight_admin:setPortalFlagCheckbox', function(data, cb)
    local flag = 0
...
RegisterNUICallback('flight_admin:setTimecycle', function(data, cb)
    if data.roomId then
