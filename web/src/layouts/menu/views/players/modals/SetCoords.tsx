    ...
    return (
        <Stack>
            ...
            <Button
                ...
                onClick={() => {
                    closeAllModals()
                    fetchNui('flight_admin:tpCoordsPlayer', { id: props.id, coordString: coordString })
                }}
            ...
            <Button
                ...
                onClick={() => {
                    closeAllModals()
                    fetchNui('flight_admin:tpCoordsPlayer', { id: props.id, coords: { x: coordX, y: coordY, z: coordZ } })
                }}
            >{locale.ui_confirm}</Button>
        </Stack>
        )
