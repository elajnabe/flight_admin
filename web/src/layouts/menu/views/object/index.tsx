            ...
            <ScrollArea style={{ height: 650, borderRadius: '5px' }} offsetScrollbars scrollbarSize={12}>
                <Accordion
                    ...
                    onChange={(value) => {
                        ...
                        fetchNui('flight_admin:setGizmoEntity', parseInt(value as string))
                    }}
                >
                            ...
                            <Accordion.Control>
                                <TextInput
                                    ...
                                    onChange={
                                        ...
                                        fetchNui('flight_admin:setEntityModel', {entity: entity, index: entityIndex, modelName: e.currentTarget.value})
                                    }
                                />
                            </Accordion.Control>
                            <Accordion.Panel>
