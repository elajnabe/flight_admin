...
interface Locale {
  ...
  ui_players: string
  ui_uptime: string
  ui_schedRestart: string
  ui_kickAll: string
  ui_warnAll: string
  ui_confirm_kickAll_description: string
  ui_heading: string
  ...
  ui_announcement_title: string
  ui_last_location: string
  ui_current_interior: string
  ui_general_tab: string
  ...
  ui_announcement_name: string
  ui_confirm_kickAll_name: string
  ui_announcement_description: string
  ...
  [
    {
      ...
      data: {
        ...
        command_openui: "%s Open Flight Admin",
        ...
        ui_players: "Players",
        ui_uptime: "Uptime",
        ui_schedRestart: "Sched. Restart",
        ui_kickAll: "Kick All",
        ui_confirm_kickAll_description: "Provide the reason for the kick",
        ui_warnAll: "Warn All",
        ui_heading: "Heading",
        ...
        ui_ban: "Ban",
        ui_freeze: "Freeze",
        ui_time_freeze: "Unfreeze Time",
        ui_time_not_freeze: "Freeze Time",
        ui_time: "Time",
        ui_sync: "Sync",
        ...
        ui_goto: "Go to",
        ui_bring: "Bring",
        ui_tp_into_veh: "TP into Veh.",
        ui_goto_back: "Go Back",
        ...
        ui_announcement_name: "Announcement Message",
        ui_confirm_kickAll_name: "Kick Message",
        ui_announcement_description: "Send a message that shows to the whole server.",
        ...
        ui_discord: "Flight Development Discord",
        ui_audio: "Audio",
...
const LocaleProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [locale, setLocale] = useState<Locale>({
    ...
    ui_kickAll: '',
    ui_warnAll: '',
    ui_confirm_kickAll_description: '',
    ui_heading: '',
    ui_interior_id: '',
    ui_current_room: '',
    ui_teleport: '',
    ...
    ui_announcement_name: '',
    ui_confirm_kickAll_name: '',
    ui_announcement_description: '',
    ui_add_entity: '',
